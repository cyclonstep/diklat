...
/**
 * This is the model class for table "intansi".
 *
 * The followings are the available columns in table 'intansi':
 * @property integer $id
 ...
 * @property User[] $users
 */
class Intansi extends CActiveRecord
{
	/**
	 ...
	 * @return Intansi the static model class
	 */
