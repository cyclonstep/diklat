...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 21, 2015 at 02:36 PM
...
ALTER TABLE `tbl_nilai`
 ADD PRIMARY KEY (`id`), ADD KEY `id_peserta` (`id_peserta`), ADD KEY `id_status_pelatihan` (`id_status_pelatihan`);
...
ALTER TABLE `tbl_status_pelatihan`
 ADD PRIMARY KEY (`id`), ADD KEY `pelatihan_id` (`pelatihan_id`), ADD KEY `id_pengajar` (`id_pengajar`);
...
--
ALTER TABLE `tbl_nilai`
ADD CONSTRAINT `idpeserta` FOREIGN KEY (`id_peserta`) REFERENCES `tbl_users` (`id`),
ADD CONSTRAINT `idstatuspelatihan` FOREIGN KEY (`id_status_pelatihan`) REFERENCES `tbl_status_pelatihan` (`id`);
...
ADD CONSTRAINT `idpengajar` FOREIGN KEY (`id_pengajar`) REFERENCES `tbl_users` (`id`);
